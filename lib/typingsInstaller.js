...
(function (ts) {
    ts.Diagnostics = {
        ...
        Use_full_down_level_iteration_for_iterables_and_arrays_for_for_of_spread_and_destructuring_in_ES5_Slash3: { code: 6149, category: ts.DiagnosticCategory.Message, key: "Use_full_down_level_iteration_for_iterables_and_arrays_for_for_of_spread_and_destructuring_in_ES5_Sl_6149", message: "Use full down-level iteration for iterables and arrays for 'for-of', spread, and destructuring in ES5/3." },
        Enable_all_strict_type_checks: { code: 6150, category: ts.DiagnosticCategory.Message, key: "Enable_all_strict_type_checks_6150", message: "Enable all strict type checks." },
...
(function (ts) {
    ...
    ts.optionDeclarations = [
        ...
        },
        {
            ...
            type: "boolean",
            description: ts.Diagnostics.Use_full_down_level_iteration_for_iterables_and_arrays_for_for_of_spread_and_destructuring_in_ES5_Slash3
        },
        {
            name: "baseUrl",
            type: "string",
        ...
        },
        {
            name: "strict",
            type: "boolean",
            description: ts.Diagnostics.Enable_all_strict_type_checks
        },
        {
            name: "plugins",
            type: "list",
