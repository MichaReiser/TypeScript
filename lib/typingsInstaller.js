...
(function (ts) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind[SyntaxKind["IntKeyword"] = 133] = "IntKeyword";
...
(function (ts) {
    ...
    function generateTSConfig(options, fileNames) {
        ...
        function writeConfigurations() {
            ...
            var knownKesyCount = ts.getOwnKeys(configurations.compilerOptions).length;
            ...
            result.push("}");
            return result.join(ts.sys.newLine);
        }
    }
