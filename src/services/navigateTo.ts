...
namespace ts.NavigateTo {
    ...
    export function getNavigateToItems(sourceFiles: SourceFile[], checker: TypeChecker, cancellationToken: CancellationToken, searchValue: string, maxResultCount: int, excludeDtsFiles: boolean): NavigateToItem[] {
